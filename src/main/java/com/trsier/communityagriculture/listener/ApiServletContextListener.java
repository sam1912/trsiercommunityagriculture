package com.trsier.communityagriculture.listener;
...
import com.trsier.communityagriculture.service.ReceivingInformationService;
...
public class ApiServletContextListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent arg0) {
		...
		ReceivingInformationService receivingInformationService = wc.getBean(ReceivingInformationService.class);
		...
		receivingInformationService.deleteAll();
		receivingInformationService.getAddress();
	}
}
