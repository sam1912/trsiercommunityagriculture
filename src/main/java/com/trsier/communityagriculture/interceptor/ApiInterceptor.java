package com.trsier.communityagriculture.interceptor;
...
import com.trsier.communityagriculture.service.AccessLogService;
import com.trsier.communityagriculture.service.ApiInfoService;
import com.trsier.communityagriculture.service.AppKeyService;
...
public class ApiInterceptor implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object arg2) throws Exception {
		System.out.println(request.getParameter("apiName")+"aaaaaaaaaaaaaaaaaaaaaaaaaaa");
		String apiName = request.getParameter("apiName");
		...
		System.out.println(request.getParameter("appId")+"bbbbbbbbbbbbbbbbbbbbbbbbb");
